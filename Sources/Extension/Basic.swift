...
struct DTraits
{
    ...
    static func map_to_device(identifier: String) -> String { // swiftlint:disable:this cyclomatic_complexity
                ...
                case "i386", "x86_64":                          return "Simulator \(map_to_device(identifier: ProcessInfo().environment["SIMULATOR_MODEL_IDENTIFIER"] ?? "iOS"))"
                ...
                case "AppleTV6,2": return "Apple TV 4K"
                case "i386", "x86_64": return "Simulator \(map_to_device(identifier: ProcessInfo().environment["SIMULATOR_MODEL_IDENTIFIER"] ?? "tvOS"))"
                default: return identifier
                }
                #endif
            }
